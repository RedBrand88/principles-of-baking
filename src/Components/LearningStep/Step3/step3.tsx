...
const Step3 = () => {
  return (
    <div>
      ...
      <p>
        This is what makes bread rise. The yeast consumes the sugars in the flour and produces carbon dioxide gas.
        The gluten in the flour traps the gas and the dough rises.
      </p>
      <p>
        The alcohol produced by the yeast gives the bread its flavor. The longer the fermentation the more alcohol
        is produced and the more flavor the bread has.
      </p>
      <p>
      ...
      <p>
        The fermentation time is also affected by the amount of yeast in the dough. The more yeast the faster the
        fermentation. The less yeast the slower the fermentation.
      </p>
      <p>
        The fermentation time is also affected by the amount of sugar in the dough. The more sugar the faster the
        fermentation. The less sugar the slower the fermentation.
      </p>
      <p>
      ...
      <p>
        Cold bulk fermentation is when the dough is placed in the refrigerator to ferment. This can take 8 to 24
        hours depending on the temperature of the refrigerator. This is used to develop more flavor in the bread.
        and it can really help you make bread fit into your schedule.
      </p>
      <p>
